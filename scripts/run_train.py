...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run MOT tracker on train split.")
    parser.add_argument("--data-root", type=Path, required=True, help="Path to evs_mot-train.")
...
def main() -> None:
    ...
    for seq_dir in sorted(p for p in args.data_root.iterdir() if p.is_dir()):
