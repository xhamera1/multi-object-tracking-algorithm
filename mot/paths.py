"""Default paths relative to repository root (cwd when running CLIs)."""
...
CONFIG = Path("config/tracker/default.yaml")
GRID_SEARCH_CONFIG = Path("config/tuning/grid_search.yaml")
